        ...
        <div className="space-y-4">
          <div className="border-2 border-dashed border-gray-300 dark:border-slate-700 rounded-lg p-8 text-center hover:border-teal-500 dark:hover:border-teal-400 transition-colors bg-gray-50 dark:bg-slate-800/50">
            ...
            >
              ...
              <span className="text-[10px] text-gray-400 dark:text-gray-500 mt-1 uppercase font-bold tracking-widest">
                MP4, AVI, MOV
              </span>
            </label>
          </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className={`flex items-center px-6 py-2 rounded-xl text-sm font-bold text-white transition-all ${
                !file || loading
